...
#include "com_example_sahityakumarsuman_newmaker_BitmapCropTask.h"
...
JNIEXPORT jboolean JNICALL Java_com_example_sahityakumarsuman_newmaker_BitmapCropTask_cropCImg
